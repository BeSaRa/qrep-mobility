...
import 'package:ebla/presentations/features/training/widgets/my_courses_widgets/my_courses_filter_chips.dart';
...
class _MyTrainingViewState extends State<MyTrainingView> {
  ...
  late GetMyTrainingCoursesBloc getMyTrainingCoursesBloc;
  @override
  void initState() {
    super.initState();
    getMyTrainingCoursesBloc = instance<GetMyTrainingCoursesBloc>();
  }
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => getMyTrainingCoursesBloc
            ..add(const GetMyTrainingCoursesEvent.started(
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<GetMyTrainingCoursesBloc, GetMyTrainingCoursesState>(
          listener: (context, state) {
            state.mapOrNull(
              done: (value) {
                log("zak ${value.coursesResponse.toString()}");
              },
            );
          },
          builder: (context, state) {
            return state.map(
              ...
              error: (value) {
                return ErrorGlobalWidget(
                  ...
                  onPressed: () {
                    ...
                    context.read<GetMyTrainingCoursesBloc>().add(
                            const GetMyTrainingCoursesEvent.started(
                                GetAllCoursesRequestModel(
                          pageIndex: 1,
                          pageSize: 5,
                          name: "",
                ...
                final bloc      = context.read<GetMyTrainingCoursesBloc>();
                  ...
                  child: NotificationListener<ScrollNotification>(
                    onNotification: (scrollInfo) {
                      ...
                      if (scrollInfo.metrics.pixels ==
                        ...
                        bloc.add(GetMyTrainingCoursesEvent.fetchNextPage(nextPageRequest),);
                      }
                      return true;
                    },
                        ...
                        slivers: [
                          SliverToBoxAdapter(
                              child: Container(
                                ...
                                padding: EdgeInsets.symmetric(horizontal: AppSizeW.s16, vertical: AppSizeH.s16),
                                child: Column(
                                  ...
                                  children: [
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              padding: EdgeInsets.symmetric(
                                                  horizontal: AppSizeW.s8, vertical: AppSizeW.s5),
                                    ...
                                    const TrainingSearchBar(isCommingFromMyCourses: true),
                                    SizedBox(height: AppSizeH.s16),
                          ...
                          if (value.isApplyFilterLoading)
                            ...
                            SliverList(
                              delegate: SliverChildBuilderDelegate(
                                childCount: courses.length + (pager?.hasNextPage == true ? 1 : 0),
                                (context, index) {
