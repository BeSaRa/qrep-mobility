            ...
            return ValueListenableBuilder<bool>(
                ...
                builder: (context, expanded, child) {
                  ...
                  return BlocListener<StreamBloc, StreamState>(
                    ...
                    child: BlocConsumer<StartStreamBloc, StartStreamState>(
                        //zak
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: expanded || (!expanded && webRTCCubit.state.isMiniScreen == true)
                                                                          ? const Icon(Icons.close,
                                                                              key: ValueKey(
                                                                                  "closeIcon"))
                                                                          : Image.asset(
                                                                              ImageAssets.chatBot,
                                                                              key: const ValueKey("avatarIcon")),
                                                                    ),
                                                                  ),
                                                                ),
                                                              ));
