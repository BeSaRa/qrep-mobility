                          ...
                          child: MultiBlocProvider(
                            providers: [
                              BlocProvider<ChatHistoryCubit>.value(
                                  value: BlocProvider.of<ChatHistoryCubit>(
                                      context)),
                              ...
                              BlocProvider<SendFeedbackBloc>.value(
                                  value: BlocProvider.of<SendFeedbackBloc>(
                                      context)),
                              BlocProvider(
                                create: (context) => StreamBloc(
                                  startStreamUsecase:
                                                                    ...
                                                                    suffixIcon:
                                                                        GestureDetector(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              color: Theme.of(context).brightness == Brightness.dark ? ColorManager.white : Theme.of(context).primaryColor,
                                                                            )),
                                                                    hint: AppStrings()
                                                                        .writeUourMessage,
                                                                  );
