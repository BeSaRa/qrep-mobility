      ...
      builder: (context, LookupState state) {
        return state.map(
          ...
          loadedLookup: (value) {
                          ...
                          children: [
                                ...
                                gridItemChildBuilder: (context, index) {
                                  return MultiBlocProvider(
                                    ...
                                    child: GridItemWidget(
                                      ...
                                      sellKPI: SellGridKPIs.values[index],
                                      rentKPI: null,
                                      mortgageKPI: null,
                                    ),
                                  );
                            ...
                            Padding(
                              ...
                              child: BlocProvider.value(
                                value: topvaluesBloc,
                                child: const StatisticsTopSellWidget(),
                              ),
                            ),
                            ...
                            BlocBuilder(
                              bloc: sellTransactionBloc,
                              builder: (context, SellTransactionState state) {
                                        ...
                                        FlutterCustomPagination(
                                          currentPage: (context
                                              ...
                                              (context
                                                  ...
                                                  1),
                                          limitPerPage: 5,
                                          totalDataCount: sellTransactionBloc
                                              ...
                                              FlutterCustomPagination(
                                                ...
                                                onPreviousPage: (previousPage) {
                                                  context.read<SellBloc>().requestSell = context
                                                      ...
                                                      .requestSell
                                                      .copyWith(
                                                          offset: ((context.read<SellBloc>().requestSell.offset ??
                                                                          0) ~/
                                                                      (context
                                                                              .read<
                                                                                  SellBloc>()
                                                  ...
                                                  context.read<SellBloc>().requestSell = context.read<SellBloc>().requestSell.copyWith(
                                                      offset: (((sellTransactionBloc
                                                          ...
                                                          ? (sellTransactionBloc
                                                              ...
                                                              (context.read<SellBloc>().requestSell.limit ??
                                                                  5)
                                                          : ((sellTransactionBloc.sellTransaction?.count ?? 0) ~/
                                                                  (context
                                                                          .read<SellBloc>()
                                                                          .requestSell
                                                                          .limit ??
                                                                      1)) *
                                                              (context.read<SellBloc>().requestSell.limit ?? 1)));
                                                  sellTransactionBloc.add(
                                                      SellTransactionEvent
                                                          .started(
                                                              request: context
            ...
            // BlocBuilder<SellDefaultBloc, SellDefaultState>(
