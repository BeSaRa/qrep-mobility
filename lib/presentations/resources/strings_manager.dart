...
// String nickName = "nick_name".tr();
  ...
  String myCourses = "my_courses".tr();
  String sessionDate = "session_date".tr();
  String readMore = "read_more".tr();
  String details = "details".tr();
  String noCoursesEnrolled = "no_courses_enrolled".tr();
  String free = "free".tr();
  String showingResults = "showing_results".tr();
  String registerNow = "register_now".tr();
  String courseDescription = "course_description".tr();
  String targetAudience = "target_audience".tr();
  String courseRequirements = "course_requirements".tr();
  String courseDocuments = "course_documents".tr();
  String courseLink = "course_link".tr();
  String trainingSessions = "training_sessions".tr();
  String thereAreNoRequirements = "there_are_no_requirements".tr();
  String thereAreNoDocuments = "there_are_no_documents".tr();
  String courseProvider = "course_provider".tr();
  String certificateType = "certificate_type".tr();
  String coursesAndExams = "courses_and_exams".tr();
  String selectEndDate = "select_end_date".tr();
  String selectStartDate = "select_start_date".tr();
  String all = "all".tr();
  String course = "course".tr();
  String exam = "exam".tr();
  String type = "type".tr();
  String close = "close".tr();
  String seeLocationOnMap = "see_location_on_map".tr();
  String courseFees = "course_fees".tr();
  String qr = "qr".tr();
  String address = "address".tr();
  String time = "time".tr();
  String numberOfDdays = "number_of_days".tr();
  String registrationDeadline = "registration_deadline".tr();
  String trainingLocation = "training_location".tr();
  String noSessions = "no_sessions".tr();
  String registerYourInterest = "register_your_interest".tr();
  String paid = "paid".tr();
  String inactive = "inactive".tr();
  String active = "active".tr();
  String status = "status".tr();
  String searchByCourseName = "search_by_course_name".tr();
  String remote = "remote".tr();
  String onSite = "on_site".tr();
