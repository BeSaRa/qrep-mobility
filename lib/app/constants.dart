class Constant {
  ...
  static const String webUrl =
      'http://qrep1-eblacorp.edge.eu.ztna.trendmicro.com/';
  static const String secondaryBaseUrl = 'https://qrepcms.mm.gov.qa/';

  // static const String baseUrl = 'http://192.168.52.4:9080/mme-services';
  // static const String webUrl = 'http://192.168.52.5:3000/';
  // static const String secondaryBaseUrl = 'http://192.168.52.5:8055';
