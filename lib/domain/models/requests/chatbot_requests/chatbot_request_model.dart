...
//----------------------------- send Candidate -------------------------------------
@freezed
abstract class MainSendCandidateRequestModel with _$MainSendCandidateRequestModel {
  const factory MainSendCandidateRequestModel({
    @Default(SendCandidateRequestModel())  candidate
  }) = _MainSendCandidateRequestModel;
