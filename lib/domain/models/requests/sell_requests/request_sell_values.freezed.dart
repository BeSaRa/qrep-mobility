...
/// @nodoc
abstract class $RequestSellValuesCopyWith<$Res> {
  factory $RequestSellValuesCopyWith(
          RequestSellValues value, $Res Function(RequestSellValues) then) =
      _$RequestSellValuesCopyWithImpl<$Res, RequestSellValues>;
  @useResult
  $Res call(
      {num areaCode,
      num? areaFrom,
...
/// @nodoc
class _$RequestSellValuesCopyWithImpl<$Res, $Val extends RequestSellValues>
    implements $RequestSellValuesCopyWith<$Res> {
  _$RequestSellValuesCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RequestSellValuesImplCopyWith<$Res>
    implements $RequestSellValuesCopyWith<$Res> {
  factory _$$RequestSellValuesImplCopyWith(_$RequestSellValuesImpl value,
          $Res Function(_$RequestSellValuesImpl) then) =
      __$$RequestSellValuesImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {num areaCode,
...
/// @nodoc
class __$$RequestSellValuesImplCopyWithImpl<$Res>
    extends _$RequestSellValuesCopyWithImpl<$Res, _$RequestSellValuesImpl>
    implements _$$RequestSellValuesImplCopyWith<$Res> {
  __$$RequestSellValuesImplCopyWithImpl(_$RequestSellValuesImpl _value,
...
class _$RequestSellValuesImpl implements _RequestSellValues {
  ...
  factory _$RequestSellValuesImpl.fromJson(Map<String, dynamic> json) =>
      _$$RequestSellValuesImplFromJson(json);
...
// int? streetNo,
  ...
  _$$RequestSellValuesImplCopyWith<_$RequestSellValuesImpl> get copyWith =>
      __$$RequestSellValuesImplCopyWithImpl<_$RequestSellValuesImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RequestSellValuesImplToJson(
      this,
    );
  }
}

abstract class _RequestSellValues implements RequestSellValues {
  factory _RequestSellValues(
      {final num areaCode,
      final num? areaFrom,
      final num? areaTo,
      final int? issueDateEndMonth,
  ...
  factory _RequestSellValues.fromJson(Map<String, dynamic> json) =
      _$RequestSellValuesImpl.fromJson;
