...
class _$LookupResponseCopyWithImpl<$Res, $Val extends LookupResponse>
  ...
  $Res call({
    ...
    Object? halfYearDurations = null,
    Object? quarterYearDurations = null,
    Object? spaces = null,
...
class _$RentLookupResponseImpl implements _RentLookupResponse {
  const _$RentLookupResponseImpl(
      ...
      : _rooms = rooms,
        ...
        _quarterYearDurations = quarterYearDurations,
        _spaces = spaces,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._halfYearDurations, _halfYearDurations) &&
            const DeepCollectionEquality()
                .equals(other._quarterYearDurations, _quarterYearDurations) &&
            const DeepCollectionEquality().equals(other._spaces, _spaces) &&
            const DeepCollectionEquality()
                .equals(other._unitStatus, _unitStatus) &&
            const DeepCollectionEquality()
  ...
  _$$RentLookupResponseImplCopyWith<_$RentLookupResponseImpl> get copyWith =>
      __$$RentLookupResponseImplCopyWithImpl<_$RentLookupResponseImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RentLookupResponseImplToJson(
      this,
    );
  }
}
...
class _$LookupModelCopyWithImpl<$Res, $Val extends LookupModel>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      yoy: null == yoy
          ? _value.yoy
          : yoy // ignore: cast_nullable_to_non_nullable
              as int,
...
class __$$RentLookupModelImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$RentLookupModelImpl(
      value: null == value
          ? _value.value
          : value // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$RentLookupModelImpl implements _RentLookupModel {
  ...
  factory _$RentLookupModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$RentLookupModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.yoy, yoy) || other.yoy == yoy) &&
  ...
  _$$RentLookupModelImplCopyWith<_$RentLookupModelImpl> get copyWith =>
      __$$RentLookupModelImplCopyWithImpl<_$RentLookupModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RentLookupModelImplToJson(
      this,
    );
  }
}
...
abstract class _RentLookupModel implements LookupModel {
  const factory _RentLookupModel(
      ...
      final String enName,
      final int municipalityId,
      final bool isActive}) = _$RentLookupModelImpl;

  factory _RentLookupModel.fromJson(Map<String, dynamic> json) =
      _$RentLookupModelImpl.fromJson;
...
MaxParamsModel _$MaxParamsModelFromJson(Map<String, dynamic> json) {
  return _MaxParamsModel.fromJson(json);
}
...
/// @nodoc
abstract class $MaxParamsModelCopyWith<$Res> {
...
/// @nodoc
class _$MaxParamsModelCopyWithImpl<$Res, $Val extends MaxParamsModel>
    implements $MaxParamsModelCopyWith<$Res> {
  _$MaxParamsModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$MaxParamsModelImplCopyWith<$Res>
    implements $MaxParamsModelCopyWith<$Res> {
...
/// @nodoc
class __$$MaxParamsModelImplCopyWithImpl<$Res>
    extends _$MaxParamsModelCopyWithImpl<$Res, _$MaxParamsModelImpl>
    implements _$$MaxParamsModelImplCopyWith<$Res> {
  __$$MaxParamsModelImplCopyWithImpl(
  ...
  $Res call({
    ...
    return _then(_$MaxParamsModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$MaxParamsModelImpl implements _MaxParamsModel {
  ...
  factory _$MaxParamsModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$MaxParamsModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'MaxParamsModel(id: $id, fieldName: $fieldName, minVal: $minVal, maxVal: $maxVal, model: $model, isActive: $isActive)';
  }
  ...
  _$$MaxParamsModelImplCopyWith<_$MaxParamsModelImpl> get copyWith =>
      __$$MaxParamsModelImplCopyWithImpl<_$MaxParamsModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$MaxParamsModelImplToJson(
      this,
    );
  }
}

abstract class _MaxParamsModel implements MaxParamsModel {
  factory _MaxParamsModel(
      {final int id,
      final String fieldName,
      final int minVal,
      final int maxVal,
      final String model,
      final bool isActive}) = _$MaxParamsModelImpl;

  factory _MaxParamsModel.fromJson(Map<String, dynamic> json) =
      _$MaxParamsModelImpl.fromJson;
...
RentListSummary _$RentListSummaryFromJson(Map<String, dynamic> json) {
  return _RentListSummary.fromJson(json);
}
...
/// @nodoc
abstract class $RentListSummaryCopyWith<$Res> {
...
/// @nodoc
class _$RentListSummaryCopyWithImpl<$Res, $Val extends RentListSummary>
    implements $RentListSummaryCopyWith<$Res> {
  _$RentListSummaryCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RentListSummaryImplCopyWith<$Res>
    implements $RentListSummaryCopyWith<$Res> {
...
/// @nodoc
class __$$RentListSummaryImplCopyWithImpl<$Res>
    extends _$RentListSummaryCopyWithImpl<$Res, _$RentListSummaryImpl>
    implements _$$RentListSummaryImplCopyWith<$Res> {
  __$$RentListSummaryImplCopyWithImpl(
...
class _$RentListSummaryImpl implements _RentListSummary {
  ...
  @override
  String toString() {
    return 'RentListSummary(count: $count, transactionList: $transactionList)';
  }
  ...
  _$$RentListSummaryImplCopyWith<_$RentListSummaryImpl> get copyWith =>
      __$$RentListSummaryImplCopyWithImpl<_$RentListSummaryImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RentListSummaryImplToJson(
      this,
    );
  }
}
...
RentSummaryObject _$RentSummaryObjectFromJson(Map<String, dynamic> json) {
  return _RentSummaryObject.fromJson(json);
}
...
/// @nodoc
abstract class $RentSummaryObjectCopyWith<$Res> {
...
/// @nodoc
class _$RentSummaryObjectCopyWithImpl<$Res, $Val extends RentSummaryObject>
    implements $RentSummaryObjectCopyWith<$Res> {
  _$RentSummaryObjectCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RentSummaryObjectImplCopyWith<$Res>
    implements $RentSummaryObjectCopyWith<$Res> {
...
/// @nodoc
class __$$RentSummaryObjectImplCopyWithImpl<$Res>
    extends _$RentSummaryObjectCopyWithImpl<$Res, _$RentSummaryObjectImpl>
    implements _$$RentSummaryObjectImplCopyWith<$Res> {
  __$$RentSummaryObjectImplCopyWithImpl(_$RentSummaryObjectImpl _value,
...
/// @nodoc
@JsonSerializable()
class _$RentSummaryObjectImpl implements _RentSummaryObject {
  const _$RentSummaryObjectImpl(
      {this.area = 0,
  ...
  factory _$RentSummaryObjectImpl.fromJson(Map<String, dynamic> json) =>
      _$$RentSummaryObjectImplFromJson(json);
  ...
  _$$RentSummaryObjectImplCopyWith<_$RentSummaryObjectImpl> get copyWith =>
      __$$RentSummaryObjectImplCopyWithImpl<_$RentSummaryObjectImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RentSummaryObjectImplToJson(
      this,
    );
  }
}
