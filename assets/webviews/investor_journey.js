...
function setTransparentBackground(selector) {
  ...
  var buttonElements = document.querySelectorAll('div.elementor-element .elementor-element .elementor-widget-container .ekit-wid-con .elementskit-info-image-box .elementskit-box-body .elementskit-box-footer');
	if (buttonElements) {
  ...
  setTransparentBackground('body > div.mkdf-wrapper > div > div > div > div > div.elementor-element.elementor-element-7df9fad.e-con-full.e-flex.e-con.e-child > div > div > div > span > span:nth-child(2) > a');
  
  //تمكين المستثمر
  setTransparentBackground('div.elementor-element-e2a672d');
  setTransparentBackground('body > div.mkdf-wrapper > div > div > div > div > div.elementor-element.elementor-element-e2a672d.e-con-full.e-flex.e-con.e-child > div > div > div > span > span:nth-child(2) > a');
 ...
 //========================================== remove header =========================================================
	...
	setTransparentBackground('div.elementor-widget-container .elementor-shortcode span span.breadcrumb_last strong');
	var mainPageElement = document.querySelector('div.elementor-widget-container .elementor-shortcode span span a');
	if (mainPageElement) {
